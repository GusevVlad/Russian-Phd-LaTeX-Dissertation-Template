...
{Ординарные и многопоточные каскадные схемы для разделения многокомпонентных изотопных смесей в ядерном топливном цикле}
\newcommand{\thesisSpecialtyNumber}    % Диссертация, специальность, номер
{01.04.07}
\newcommand{\thesisSpecialtyTitle}     % Диссертация, специальность, название (название взято с сайта ВАК для примера)
{Теплофизика и теор. теплотехника}
...
образования <<Национальный исследовательский ядерный университет <<МИФИ>>\\<<НИЯУ МИФИ>>}
