...
\begin{axis}[
  xlabel style = {{at={(axis description cs:.98,0.02)},font=\fontsize{22}{22}\selectfont}},
  ylabel = {$\delta(\frac{E}{P}), \%$},
  ylabel style = {{at={(axis description cs:-0.01,.9)},rotate=270,anchor=south,font=\fontsize{22}{22}\selectfont}},
  xlabel = {$i$},
