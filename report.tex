...
\include{semestr_report/title}           % Титульный лист
\include{semestr_report/contents}        % Оглавление
\ifnumequal{\value{contnumfig}}{1}{}{\counterwithout{figure}{chapter}}
\ifnumequal{\value{contnumtab}}{1}{}{\counterwithout{table}{chapter}}
\include{semestr_report/introduction}    % Введение
\ifnumequal{\value{contnumfig}}{1}{\counterwithout{figure}{chapter}
}{\counterwithin{figure}{chapter}}
\ifnumequal{\value{contnumtab}}{1}{\counterwithout{table}{chapter}
}{\counterwithin{table}{chapter}}
\include{semestr_report/part1}           % Глава 1
\include{semestr_report/part2}           % Глава 2
\include{semestr_report/part3}           % Глава 3
\include{semestr_report/conclusion}      % Заключение
\include{semestr_report/acronyms}        % Список сокращений и условных обозначений
\include{semestr_report/dictionary}      % Словарь терминов
\include{semestr_report/references}      % Список литературы
\include{semestr_report/lists}           % Списки таблиц и изображений (иллюстративный материал)
...
\include{semestr_report/appendix}        % Приложения
